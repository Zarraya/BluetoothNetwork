		...
		mono.android.IGCUserPeer
{
	...
	static {
		__md_methods = 
			"";
		mono.android.Runtime.register ("BluetoothChat.DrawView, BluetoothChat, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", DrawingView.class, __md_methods);
	}


	public DrawingView (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == DrawingView.class)
	...
	public DrawingView (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == DrawingView.class)
	...
	public DrawingView (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == DrawingView.class)
	...
	public DrawingView (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == DrawingView.class)
